...
```sh
curl "https://api.grails.market/api/v1/search?q=cool&filters[minLength]=3&filters[maxLength]=5&filters[listed]=true&sortBy=price&sortOrder=asc&limit=10"
```
...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  "https://api.grails.market/api/v1/search?q=cool&export=true&filename=my-export"
```
